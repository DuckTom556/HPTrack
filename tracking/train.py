...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str,default='hptrack', help='training script name')#训练脚本名称
    parser.add_argument('--config', type=str, default='hptrack_b256', help='yaml configure file name') #baseline
