...
cfg.MODEL.BACKBONE.PRETRAINED_PATH = '/root/autodl-tmp/ZAST/HPTrack2/pretrained'
...
cfg.MODEL.BACKBONE.USE_MAMBA_S=True #用于模板图像特征聚合
cfg.MODEL.BACKBONE.USE_HP=True#用于多级特征历史提示
cfg.MODEL.BACKBONE.USE_MAMBA_T=True#用于多级特征历史提示
cfg.MODEL.BACKBONE.LAYER_INDEXES=[[10,18],[18,24],[24,30]]   # [[10,30]]#[[10,20],[20,30]]#[10,30]
cfg.MODEL.BACKBONE.NUM_LAYERS=3
