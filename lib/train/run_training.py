...
def main():
    ...
    parser.add_argument('--script', type=str, default="hptrack", help='Name of the train script.')
    parser.add_argument('--config', type=str, default="hptrack_b224_got", help="Name of the config file.")
    ...
    #parser.add_argument('--save_dir', type=str, default="E:/SOT/MODEL/HP/HPTrack3/output/train",help='the directory to save checkpoints and logs')
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 local_rank= int(args.local_rank), save_dir=args.save_dir, base_seed=args.seed,
