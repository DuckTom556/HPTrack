...
from lib.models.hptrack.backbone.hivit_backbone import BaseBackbone
import os
...
class HiViT(BaseBackbone):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000,
                 ...
                 norm_layer=nn.LayerNorm, ape=True, rpe=True, patch_norm=True,
